...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-slate-100 scroll-smooth">
      ...
      {/* Hero Section */}
      <section id="hero" className="pt-20 min-h-screen flex items-center bg-gradient-to-br from-black via-[#0f1e1d] to-[#0c1918] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Profile Image */}
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <div className="w-80 h-80 rounded-2xl bg-gradient-to-br from-blue-500 via-cyan-500 to-slate-500 p-1">
            ...
            <div className="text-center lg:text-left">
              ...
              {/* Skills */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold text-slate-200 mb-4 text-center lg:text-left">Web Development Skills:</h3>
                ...
                <h3 className="text-xl font-semibold text-slate-200 mb-4 text-center lg:text-left">Data Science Skills:</h3>
                <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                  {dataScienceSkills.map((skill, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/80 backdrop-blur-sm rounded-full text-sm font-medium border border-slate-600 hover:bg-cyan-800/50 hover:border-cyan-500 transition-all duration-300 cursor-pointer text-slate-200 shadow-sm"
                    >
                      {skill.icon}
                      {skill.name}
                    </span>
...
<section 
  id="about" 
  className={`py-20 bg-[#071a1f] text-white transition-all duration-1000 ${
...
>
  <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12">
    <div className="text-center mb-16">
      <h2 className="text-5xl font-extrabold leading-tight mb-4 bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
        About Me
      </h2>
    ...
    <div className="space-y-12">
      ...
      <div className="relative group hover:scale-[1.02] transition-transform duration-300">
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-14 h-14 bg-blue-500/10 border border-blue-600/30 rounded-full flex items-center justify-center">
          <Code className="w-7 h-7 text-blue-400" />
        </div>
        <div className="pl-20">
          <h3 className="text-2xl font-bold mb-2 text-blue-400">Frontend Development</h3>
      ...
      {/* Backend */}
      <div className="relative group hover:scale-[1.02] transition-transform duration-300">
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-14 h-14 bg-cyan-500/10 border border-cyan-600/30 rounded-full flex items-center justify-center">
          <Server className="w-7 h-7 text-cyan-400" />
        </div>
        <div className="pl-20">
          <h3 className="text-2xl font-bold mb-2 text-cyan-400">Backend Engineering</h3>
          <p className="text-slate-300 text-lg">
      ...
      {/* Databases */}
      <div className="relative group hover:scale-[1.02] transition-transform duration-300">
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-14 h-14 bg-indigo-500/10 border border-indigo-600/30 rounded-full flex items-center justify-center">
          <Database className="w-7 h-7 text-indigo-400" />
        </div>
        <div className="pl-20">
          <h3 className="text-2xl font-bold mb-2 text-indigo-400">Database Systems</h3>
          <p className="text-slate-300 text-lg">
      ...
      {/* Data Science */}
      <div className="relative group hover:scale-[1.02] transition-transform duration-300">
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-14 h-14 bg-purple-500/10 border border-purple-600/30 rounded-full flex items-center justify-center">
          <BarChart className="w-7 h-7 text-purple-400" />
        </div>
        <div className="pl-20">
          <h3 className="text-2xl font-bold mb-2 text-purple-400">Data Science & AI</h3>
          <p className="text-slate-300 text-lg">
     ...
     <section 
  id="education" 
  className={`py-20 bg-[#071a1e] text-emerald-100 transition-all duration-1000 ${
...
>
      ...
      {/* Projects Section */}
       <section 
  id="projects" 
  className={`py-20 bg-[#081b1f] text-green-100 transition-all duration-1000 ${
...
>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-slate-800/80 backdrop-blur-sm p-8 rounded-2xl border border-slate-600/50 shadow-lg">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-slate-100 mb-2">Full Stack Developer</h3>
              ...
              <div>
                <h4 className="text-lg font-semibold mb-3 text-slate-400">Key Achievements</h4>
  ...
  className={`py-20 bg-[#081b1f] text-green-100 transition-all duration-1000 ${
    visibleSections.has('contact') 
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400">saikrishnabalaka@gmail.com</p>
                    </div>
                  </a>
      ...
      {/* Footer */}
    <footer className="bg-[#081b1f] py-10 border-t border-green-900/30 text-green-100">
